    ...
    static partial class BDO_WaybillsJournalReceived
    {
        ...
        public static string findItemByNameOITM(string WBItmName, string RSBarCode, string CardCode, out string itemName)
        {
            ...
            try
            {
                ...
                {
                    Program.uiApp.StatusBar.SetSystemMessage("PleaseFillSearchingParameterOnThisBusinessPartner", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
