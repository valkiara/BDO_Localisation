...
namespace BDO_Localisation_AddOn
{
    class StatementOfCashFlows
    {
        public static void createFormItems(  SAPbouiCOM.Form oForm, out string errorText)
        {
            ...
            double top = oForm.Items.Item("2010").Top;
            double width = oForm.Items.Item("2010").Width;
            double left = oForm.Items.Item("2010").Left + width;
            double height = oForm.Items.Item("2010").Height;
        ...
        public static void exportExcel(  SAPbouiCOM.Form oForm, out string errorText)
        {
            ...
            FinancialReports.ExportToExcel(oForm, "2001", "2004", "2005", "2002", out errorText);
        }
