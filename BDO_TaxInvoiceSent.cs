...
namespace BDO_Localisation_AddOn
{
    static partial class BDO_TaxInvoiceSent
    {
        ...
        private static bool save_ntos_invoices_inv_nos(TaxInvoice oTaxInvoice, GeneralData oGeneralData, GeneralData oGeneralDataCorr, int inv_ID, out string errorText)
        {
            errorText = null;
            try
            {
        ...
        private static bool save_invoice_desc(TaxInvoice oTaxInvoice, GeneralData oGeneralData, int inv_ID, out string errorText)
        {
            errorText = null;
            try
            {
